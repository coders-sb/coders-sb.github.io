...
function ProjectSeries() {
	return (
		<>
			...
			<div className="h-24 bg-green-500">insert header</div>
			<div className="h-96 bg-red-500">project series banner</div>
			<h1 className="text-left">Winter 2021 Project Series</h1>
			<p className="text-left mt-5">
				In this project series you will work with a team of up to 4 to
				create a full stack web application using React, the industry
				standard for building user interfaces. At the end of the
				quarter, your team will participate in our showcase where you
				will be able to display your final product to a panel of judges.
				All skill levels are welcome. Stay tuned for more information on
				our panel and exciting prizes!
			</p>
			<p className="text-left mt-5">
				Throughout the quarter, we will have 7 events from week 2-9
				(with a gap week in week 8) on Thursday @ 7-8:30PM. Each meeting
				will consist of a 20-40 minute workshop and the remaining time
				will be used for checking in with your project mentor as well as
				an open space to work and ask questions. These meetings will be
				conducted using both zoom and discord. To remain qualified to
				present in our showcase, your team can only miss two events.
			</p>
			<div className="h-72 bg-blue-500">timeline infographic</div>
				...
				{workshops.map((workshop: Workshop) => (
					<div className="w-96">
						<img
							...
							className="h-80 w-80 mx-auto mt-5"
						/>
						{workshop.title}
			...
			<h1 className="text-left">Resources</h1>
			<div className="flex flex-row">
				<video loop autoPlay muted className="h-1/2 w-1/2 p-5">
					<source
						src={"https://coderssb.com/ProjectSeries/resources.mp4"}
						type="video/mp4"
					/>
				</video>
				<div className="flex flex-col p-10 text-left">
					<a href="https://drive.google.com/drive/folders/1vKSjbAbvDCfa2u7W0LTWgx4V7JVGpf_N">
						Folder with all our resources.
					</a>
					<br />
					<div>
						{"Learn how to set up your GitHub repo "}
						<a href="https://docs.google.com/document/d/1q-W8fQjpR2KVEb-9XT09cXJGcGKDkB216yfzTafJ4dA/edit">
							here
						</a>
						{"."}
					</div>
					...
					<div>
						...
						<a href="https://docs.google.com/document/d/15b8BNC9B8EbqUkhkB2pEgw-rdFdqVmXC0Hcfh5cNQFE/edit">
							here
						</a>
						{"."}
					</div>
					...
					<div>
						...
						<a href="https://www.freecodecamp.org/news/all-the-fundamental-react-js-concepts-jammed-into-this-single-medium-article-c83f9b53eac2/">
							here
						</a>
						{"."}
					</div>
					...
					<div>
						...
						<a href="https://www.youtube.com/watch?v=Ke90Tje7VS0&t=32s">
							here
						</a>
						{"."}
					</div>
					...
					<div>
						...
						<a href="https://www.youtube.com/watch?v=Law7wfdg_ls&t=858s">
							here
						</a>
						{"."}
					</div>
					...
					<div>
						...
						<a href="https://docs.google.com/document/d/1uGQxP5FYOe4NfP9nLwNEFAkvUh76P-ccARDO_ephhoE/edit">
							here
						</a>
						{"."}
					</div>
			...
			<video loop autoPlay muted className="p-5">
				<source
					src={"https://coderssb.com/ProjectSeries/happyCoding.mp4"}
					type="video/mp4"
				/>
			</video>

			<div className="h-80 bg-green-500">insert footer</div>
		</>
	);
}
